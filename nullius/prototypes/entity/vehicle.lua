...
data:extend({
  {
    ...
    impact_category = data.raw["car"]["car"].impact_category,
...

  {
    ...
    -- sound_scaling_ratio = 0.8,
    impact_category = data.raw["car"]["tank"].impact_category,
