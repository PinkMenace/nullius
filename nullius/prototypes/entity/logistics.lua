...
data:extend({
  {
    ...
    impact_category = data.raw.radar["radar"].impact_category,
  ...
  },
  {
    ...
    impact_category = data.raw.lab["lab"].impact_category,
...
data:extend({
...

  {
    ...
    impact_category = data.raw["lamp"]["small-lamp"].impact_category,
...
data:extend({
  {
    ...
    impact_category = data.raw["inserter"]["fast-inserter"].impact_category,
  ...
  --   fast_replaceable_group = "inserter",
  --   filter_count = 5,
  --   impact_category = data.raw["inserter"]["filter-inserter"].impact_category,
