...
group_with(data.raw.item["nullius-canister"], data.raw.recipe["nullius-canister"])
...
group_with(data.raw.item["duct-exhaust"], data.raw.recipe["nullius-duct-exhaust"])
group_with(data.raw.item["duct-intake"], data.raw.recipe["nullius-duct-intake"])
